...
data['contract_signed_on'] = pd.to_datetime(data['contract_signed_on'],dayfirst=True)
data['car_handover_on'] = pd.to_datetime(data['car_handover_on'],dayfirst=True)
data['Contribution Start Date'] = pd.to_datetime(data['Contribution Start Date'],dayfirst=True)
data['nps_value'] = data['nps_value'].replace('', '-1')
data['nps_value'] = data['nps_value'].fillna(value=-1)
data['nps_value'] = data['nps_value'].astype('int')
